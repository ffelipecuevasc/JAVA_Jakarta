    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(cookieOptional.isPresent()){
            ...
            try (PrintWriter out = resp.getWriter()) {
                ...
                out.println("<h4>Hola '" + cookieOptional.get() + "' ¡Iniciaste sesión!</h4>");
                out.println("<p><a href='/CookiesApp/index.html'>Volver</a></p>");
                out.println("<p><a href='/CookiesApp/logout.html'>Salir</a></p>");
                out.println("</body>");
                out.println("</html>");
            }
        }else{
